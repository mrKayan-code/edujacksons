 ...
 */
/**
 * Сущность ручной проверки решения учителем.
 * 
 * Ссылки submissionId, problemId, studentId, reviewerId являются межмодульными.
 * В соответствии с ADR 0004, для обеспечения слабой связанности модулей 
 * и возможности их будущего разделения на микросервисы, физические 
 * Foreign Keys в БД между этой таблицей и таблицами модулей submissions/problems не создаются.
 * Целостность данных обеспечивается на уровне бизнес-логики сервиса.
 */
@Entity
@Table(name = "reviews")
@Getter
